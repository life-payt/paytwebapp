...
import RowAddressBusiness from '../Widgets/Rows/RowAddressBusiness.jsx';
import MultiBarChart from '../Widgets/Charts/MultiBarChart.jsx';
...
class BusinessContent extends React.Component {
  ...
  render() {
    ...
    const data = {
        labels: dataLabels,
        datasets: [{
            label: this.state.strings.BusinessContent.dataLabel,
    ...
    const options = { 
      scales: {
        ...
        yAxes: 	[{
          ...
          scaleLabel: {
            display: true,
            labelString: this.state.strings.BusinessContent.dataLabel + ' (L)'
          }
        }]
      },
      tooltips: {
    ...
    return (
      <div>
        <div className="row"><RowAddressBusiness producer_id={this.state.party.producers[this.state.index].id} index={this.state.index}/></div>
        <div className="row"><section className="col-lg-12" ><MultiBarChart options={options} data={this.state.rawData} text={this.state.strings.BusinessContent.textLineChart}/></section></div>
      </div>
    );
  }
}

module.exports = BusinessContent;