...
class MonthChart extends React.Component {
    ...
    formatData(values){
      ...
      for(var i=0; i<values.length; i++){
          ...
          dataValues2.push(values[i].value+1);
          dataValues3.push(values[i].value+2);
          dataLabels.push(this.state.strings.Months[values[i].month]+' '+values[i].year);
      }
      ...
      const data = {
        ...
        datasets: [
          {
            label: this.state.strings.MonthChart.label,
            fill: false,
            lineTension: 0.1,
